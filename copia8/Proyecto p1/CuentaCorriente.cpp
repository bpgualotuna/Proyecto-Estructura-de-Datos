...
CuentaCorriente::CuentaCorriente(const char* idCuenta, const char* idUsuario, const char* nombre, const char* apellido,
                                double saldoInicial, int diaNacimiento, int mesNacimiento, int anioNacimiento,
                                const FechaHora& fechaCreacion, double sobregiro)
    : Cuenta(idCuenta, idUsuario, nombre, apellido, saldoInicial, diaNacimiento, mesNacimiento, anioNacimiento, fechaCreacion),
