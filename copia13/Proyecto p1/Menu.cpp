        ...
        if (tecla == 224) {
            ...
            case 16: { // Visualización de árbol AVL
                ...
                const char* opcionesAVL[] = {
                    "Visualizar AVL por edad de dueños de cuentas",
                    "Visualizar AVL por distancias de sucursales",
                    "Volver al menú principal"
                };
                int conteoOpcionesAVL = 3;
                while (true) {
                    system("cls");
                    std::cout << "\n=== VISUALIZACIÓN DE ÁRBOL AVL ===\n";
                    ...
                    if (teclaAVL == 224) {
                        ...
                        if (cursorAVL == 0) { // AVL por edad
                            // Construir AVL por edad
                            ArbolAVL arbolEdad;
                            ...
                            cuentas.recorrer([&arbolEdad, codigoSucursalActual](Cuenta* cta) {
                                ...
                                // El formato es: 01-001-1-000001-X
                                // Extrae el código de sucursal (posición 4-6)
                        ...
                        } else if (cursorAVL == 1) { // AVL por distancia
