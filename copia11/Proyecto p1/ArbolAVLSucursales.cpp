...
NodoAVL* ArbolAVLSucursales::insertarRec(NodoAVL* nodo, SucursalBancaria* sucursal) {
    ...
    // Crear una copia del código de sucursal antes de eliminar los punteros
    char* codSucursalCopia = new char[strlen(codSucursal) + 1];
    strcpy(codSucursalCopia, codSucursal);
